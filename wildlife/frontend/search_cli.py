    ...
    for animal_type, data in clusters:
        ...
        for doc in data["docs"]:
            ...
            if is_filter_enabled("weight_kg"):
                ...
                if not (max(w_min2, weight_range[0]) <= min(w_max2, weight_range[1])):
                    continue
            ...
            if is_filter_enabled("length_cm"):
                ...
                if not (max(s_min2, size_range[0]) <= min(s_max2, size_range[1])):
                    continue
            ...
            if is_filter_enabled("population"):
                ...
                if not (max(p_min2, population_range[0]) <= min(p_max2, population_range[1])):
                    continue
